                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="patient-info-profile">
                            <a href="https://doccure.dreamstechnologies.com/html/template/appointments.html" class="table-avatar">
                              <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-01.jpg" alt="Img" />
                            </a>
                            <div class="patient-name-info">
                              <span>#Apt0001</span>
                              <h5><a href="https://doccure.dreamstechnologies.com/html/template/appointments.html">Adrian Marshall</a></h5>
                            </div>
                          </div>
                      ...
                      <tr>
                        <td>
                          <div class="patient-info-profile">
                            <a href="https://doccure.dreamstechnologies.com/html/template/appointments.html" class="table-avatar">
                              <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-02.jpg" alt="Img" />
                            </a>
                            <div class="patient-name-info">
                              <span>#Apt0002</span>
                              <h5><a href="https://doccure.dreamstechnologies.com/html/template/appointments.html">Kelly Stevens</a></h5>
                            </div>
                          </div>
                      ...
                      <tr>
                        <td>
                          <div class="patient-info-profile">
                            ...
                            <div class="patient-name-info">
                              <span>#Apt0003</span>
                              <h5><a href="https://doccure.dreamstechnologies.com/html/template/appointments.html">Samuel Anderson</a></h5>
                            </div>
                          </div>
                      ...
                      <tr>
                        <td>
                          <div class="patient-info-profile">
                            ...
                            <div class="patient-name-info">
                              <span>#Apt0004</span>
                              <h5><a href="https://doccure.dreamstechnologies.com/html/template/appointments.html">Catherine Griffin</a></h5>
                            </div>
                          </div>
                      ...
                      <tr>
                        <td>
                          <div class="patient-info-profile">
                            <a href="https://doccure.dreamstechnologies.com/html/template/appointments.html" class="table-avatar">
                              <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-05.jpg" alt="Img" />
                            </a>
                            <div class="patient-name-info">
                              <span>#Apt0005</span>
                              <h5><a href="https://doccure.dreamstechnologies.com/html/template/appointments.html">Robert Hutchinson</a></h5>
                            </div>
                          </div>
              ...
              <div class="dashboard-card w-100">
                <div class="dashboard-card-head">
                  ...
                  <div class="card-view-link">
                    <a href="https://doccure.dreamstechnologies.com/html/template/my-patients.html">View All</a>
                  </div>
                </div>
                <div class="dashboard-card-body">
                  <div class="d-flex recent-patient-grid-boxes">
                    <div class="recent-patient-grid">
                      <a href="https://doccure.dreamstechnologies.com/html/template/patient-details.html" class="patient-img">
                        <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-01.jpg" alt="Img" />
                      </a>
                      <h5><a href="https://doccure.dreamstechnologies.com/html/template/patient-details.html">Adrian Marshall</a></h5>
                    ...
                    <div class="recent-patient-grid">
                      ...
                      <h5><a href="https://doccure.dreamstechnologies.com/html/template/patient-details.html">Kelly Stevens</a></h5>
              ...
              <div class="upcoming-appointment-card">
                ...
                <div class="upcoming-patient-info">
                  <div class="info-details">
                    <span class="img-avatar"><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-01.jpg" alt="Img" /></span>
                    <div class="name-info">
                      <span>#Apt0001</span>
                  ...
                  <div class="circle-bg">
                    <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/bg/dashboard-circle-bg.png" alt="Img" />
                  </div>
                </div>
                <div class="appointment-card-footer">
                  <h5><i class="fa-solid fa-video"></i>Video Appointment</h5>
                  <div class="btn-appointments">
                    <a href="https://doccure.dreamstechnologies.com/html/template/chat-doctor.html" class="btn">Chat Now</a>
                    <a href="https://doccure.dreamstechnologies.com/html/template/doctor-appointment-start.html" class="btn">Start Appointment</a>
                  </div>
                </div>
              </div>
              <div class="dashboard-card w-100">
                <div class="dashboard-card-head">
                  ...
                  <div class="card-view-link">
                    <a href="https://doccure.dreamstechnologies.com/html/template/invoices.html">View All</a>
                  </div>
                </div>
                <div class="dashboard-card-body">
                  <div class="table-responsive">
                    <table class="table dashboard-table">
                      <tbody>
                        <tr>
                          <td>
                            <div class="patient-info-profile">
                              <a href="https://doccure.dreamstechnologies.com/html/template/invoices.html" class="table-avatar">
                                <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-01.jpg" alt="Img" />
                              </a>
                              <div class="patient-name-info">
                                <h5><a href="https://doccure.dreamstechnologies.com/html/template/invoices.html">Adrian</a></h5>
                                <span>#Apt0001</span>
                              </div>
                            </div>
                          </td>
                          ...
                          <td>
                            <div class="apponiment-view d-flex align-items-center">
                              <a href="https://doccure.dreamstechnologies.com/html/template/invoice-view.html"><i class="isax isax-eye4"></i></a>
                            </div>
                          </td>
                        </tr>
                        <tr>
              ...
              <div class="dashboard-card-body">
                  ...
                  <div class="clinic-head">
                    <div class="clinic-info">
                      <span class="clinic-img">
                        <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/clinic-02.jpg" alt="Img" />
                      </span>
                      <h6>Sofi’s Clinic</h6>
                    </div>
                ...
                <div class="clinic-available mb-0">
                  <div class="clinic-head">
                    <div class="clinic-info">
                      <span class="clinic-img">
                        <img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/clinic-01.jpg" alt="Img" />
                      </span>
