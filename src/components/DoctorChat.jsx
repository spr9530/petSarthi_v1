													...
													<div class="swiper-slide">
														<div class="top-contacts-box">
															<div class="profile-img online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-01.jpg" alt="Img" />
															</div>
														</div>
													</div>
													<div class="swiper-slide">
														<div class="top-contacts-box">
															<div class="profile-img online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-04.jpg" alt="Img" />
															</div>
														</div>
													</div>
													<div class="swiper-slide">
														<div class="top-contacts-box">
															<div class="profile-img online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-03.jpg" alt="Img" />
															</div>
														</div>
													</div>
													<div class="swiper-slide">
														<div class="top-contacts-box">
															<div class="profile-img online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-08.jpg" alt="Img" />
															</div>
														</div>
													</div>
													<div class="swiper-slide">
														<div class="top-contacts-box">
															<div class="profile-img online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-06.jpg" alt="Img" />
															</div>
														</div>
													</div>
													<div class="swiper-slide">
														<div class="top-contacts-box">
															<div class="profile-img online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-07.jpg" alt="Img" />
															</div>
														</div>
													</div>
												</div>
										...
										<div class="sidebar-body chat-body" id="chatsidebar">
											...
											<ul class="user-list">
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div class="avatar avatar-online">
															<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-01.jpg" alt="image" />
														</div>
												...
												<li class="user-list-item">
													<a href="javascript:void(0);" >
															<div class="avatar ">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/doctor-profile-img.jpg" alt="image" />
															</div>
														<div class="users-list-body">
															<div>
												...
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div class="avatar avatar-online">
															<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-04.jpg" alt="image" />
														</div>
														<div class="users-list-body">
															<div>
											...
											<ul class="user-list">
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div class="avatar avatar-online">
															<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-02.jpg" alt="image" />
														</div>
														<div class="users-list-body">
															<div>
																<h5>Kelly Stevens</h5>
												...
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div>
															<div class="avatar avatar-online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-05.jpg" alt="image" />
															</div>
														</div>
														<div class="users-list-body">
															<div>
												...
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div class="avatar">
															<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-08.jpg" alt="image" />
														</div>
														<div class="users-list-body">
															<div>
																<h5>Emily Musick</h5>
												...
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div>
															<div class="avatar avatar-online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-03.jpg" alt="image" />
															</div>
														</div>
														<div class="users-list-body">
															<div>
												...
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div>
															<div class="avatar avatar-online">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-07.jpg" alt="image" />
															</div>
														</div>
														<div class="users-list-body">
															<div>
												...
												<li class="user-list-item">
													<a href="javascript:void(0);" >
														<div>
															<div class="avatar">
																<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-06.jpg" alt="image" />
															</div>
														</div>
														<div class="users-list-body">
															<div>
										...
										<div class="messages">
											<div class="chats">
												<div class="chat-avatar">
													<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/profile-06.jpg" class="dreams_chat" alt="image" />
												</div>
															...
															<ul>
																<li class="emoj-action"><a href="javascript:void(0);"  ><i class="fa-regular fa-face-smile"></i></a>
																	<div class="emoj-group-list">
																		<ul>
																			<li><a href="javascript:void(0);" ><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/emoj-icon-01.svg"  alt="Icon"/></a></li>
																			<li><a href="javascript:void(0);" ><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/emoj-icon-02.svg"  alt="Icon"/></a></li>
																			<li><a href="javascript:void(0);" ><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/emoj-icon-03.svg"  alt="Icon"/></a></li>
																			<li><a href="javascript:void(0);" ><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/emoj-icon-04.svg"  alt="Icon"/></a></li>
																			<li><a href="javascript:void(0);" ><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/emoj-icon-05.svg"  alt="Icon"/></a></li>
											...
											<div class="chats chats-right">
												<div class="chat-content">
													...
													<div class="message-content ">
														...
														<div class="chat-voice-group">
															<ul>
																<li><a href="javascript:void(0);"><span><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/play-01.svg" alt="image" /></span></a></li>
																<li><img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/voice.svg" alt="image" /></li>
																<li>0:05</li>
															</ul>
														</div>
													</div>
												...
												<div class="chat-avatar">
													<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/doctors-dashboard/doctor-profile-img.jpg" class="dreams_chat" alt="image" />
												</div>
											</div>
											<div class="chats">
												<div class="chat-avatar">
												...
												<div class="chat-content">
													...
													<div class="message-content award-link chat-award-link">
														...
														<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/sending-img.jpg" alt="img" />
														<div class="emoj-group">
															<ul>
																<li class="emoj-action"><a href="javascript:void(0);"  ><i class="fa-regular fa-face-smile"></i></a>
																	<div class="emoj-group-list">
															...
															<ul class="nav mb-0">
																<li>
																	<div class="image-download-col">
																		<a href="https://doccure.dreamstechnologies.com/html/template/assets/img/media/media-02.jpg" data-fancybox="gallery" class="fancybox">
																			<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/media/media-02.jpg" alt="Img" />
																		</a>
																...
																<li>
																	<div class="image-download-col ">
																		<a href="https://doccure.dreamstechnologies.com/html/template/assets/img/media/media-03.jpg" data-fancybox="gallery" class="fancybox">
																			<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/media/media-03.jpg" alt="Img" />
																		</a>
																	</div>
																</li>
																<li>
																	<div class="image-download-col image-not-download">
																		<a href="https://doccure.dreamstechnologies.com/html/template/assets/img/media/media-01.jpg" data-fancybox="gallery" class="fancybox">
																			<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/media/media-01.jpg" alt="Img" />
																			<span>10+</span>
																		</a>
																	</div>
																</li>
											...
											<div class="chats">
												...
												<div class="chat-content">
													...
													<div class="like-chat-grp">
														<ul>
															<li class="like-chat"><a href="javascript:void(0);">2<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/like.svg"  alt="Icon"/></a></li>
															<li class="comment-chat"><a href="javascript:void(0);">2<img src="https://doccure.dreamstechnologies.com/html/template/assets/img/icons/heart.svg"  alt="Icon"/></a></li>
														</ul>
													</div>
												</div>
											</div>
